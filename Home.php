...
<html lang="en">
  ...
  <body>
    ...
    <section class=" text-center">
      <div class="container">
        <h1 class="jumbotron-heading">หน้าหลัก</h1>
        <p class="lead text-muted">อันนี้เอาไว้แปะโปรไฟล์ทำหรับหางาน</p>
        <p>
          <a href="Submit.html" class="btn btn-primary my-2">สร้างโปรไฟล์</a>
        </p>
      </div>
    </section>
